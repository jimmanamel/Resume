...
const CareerContainer = () => {
  ...
  return (
    <div className="careerContainer">
      <u className="careerContainer__Header">Career Summary</u>
          ...
          <div className="careerCover">
            <div className="career2">
              <span>
                ...
                <p>
                  B.Tech graduate in computer science and engineering, from CEC,
                  in the year of 2020
                </p>
              </span>
          ...
          <div className="careerCover">
            <div className="career3">
              <span>
                ...
                <p>
                  experience in working on variety of frontend, backend and
