...
const CareerContainer = lazy(() => import("./Components/Career/CareerContainer"));
const ProjectsContainer = lazy(() => import("./Components/Projects/ProjectsContainer"));
const ContactsContainer = lazy(() => import("./Components/Contacts/ContactsContainer"));
...
const routes = [
  ...
  { path: "/Resume/Contacts", element: <ContactsContainer /> },
